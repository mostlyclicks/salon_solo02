...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "Salon Solo - Salon and spa services in La Crosse and Onalaska Wisconsin - (608) 782-1243"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  config.google_analytics_page_code = "UA-1154327-16"
  ...
  # config.dragonfly_secret = "592c47e37de249af407f380f481c86af715dcea98ad63aee"
